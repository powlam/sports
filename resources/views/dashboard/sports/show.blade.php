    ...
    <div class="flex justify-center flex-wrap space-x-4 bg-yellow-50">
        <x-dashboard.related-card>
            <x-slot name="title">
                ...
                <x-dashboard.button-link-mini href="{{ route('dashboard.sportDisciplines.create', ['sport_id' => $sport->id]) }}" color="yellow" class="absolute top-1 right-1">
