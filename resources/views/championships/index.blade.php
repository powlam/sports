<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    @forelse ($championships as $championship)
                        <tr class="hover:bg-purple-100">
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200">
                                <a href="{{ route('championships.show', $championship->id) }}" class="inline-block text-purple-600 p-2 rounded-full hover:bg-purple-200">
            ...
            <x-button-link href="{{ route('championships.create') }}" color="purple">
